...
*Madrid · Septiembre 2023 – Febrero 2024*

- Modelos de forecasting usando NLP y **NER** pre-entrenados (spaCy, Hugging Face).
- Dashboards interactivos en **Streamlit** para comunicar resultados a stakeholders no técnicos.

### Icaria Technology — AI Intern

*Madrid · Febrero 2023 – Agosto 2023*

- Mejora de infraestructura ML mediante buenas prácticas de Python y control de versiones con **Git**.
- Desarrollo de algoritmos ML para análisis de texto semi-estructurado y detección de datos sensibles.

### Universidad Carlos III de Madrid — Research Assistant

*Leganés · Enero 2022 – Enero 2023*
...
[Ver perfil completo en LinkedIn :material-linkedin:](https://www.linkedin.com/in/enrique-botia-barbera){ .md-button }
